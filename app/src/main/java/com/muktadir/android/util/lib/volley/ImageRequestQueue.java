...
public class ImageRequestQueue {
    ...
    private static ImageRequestQueue mInstance;
    ...
    private ImageRequestQueue(Context context) {
        ...
        mCustomImageLoader = new CustomImageLoader(mCtx, mRequestQueue,
                new LruBitmapCache(mCtx) {
                    //new ImageLoader.ImageCache() {
                    private final LruCache<String, Bitmap> cache = new LruCache<String, Bitmap>(20);
    ...
    public static synchronized ImageRequestQueue getInstance(Context context) {
        if (mInstance == null) {
