...
public class JsonBodyObjectRequest<T> extends Request<T> {

    private static final String TAG = JsonBodyObjectRequest.class.getSimpleName();
    ...
    public JsonBodyObjectRequest(String url, Response.ErrorListener listener, Class<T> classType) {
        this(Method.GET, url, listener, classType);
    }


    public JsonBodyObjectRequest(int method, String url, Response.ErrorListener errorListener, Class<T> classType) {
        this(method, url, null, errorListener, classType);
    }

    public JsonBodyObjectRequest(int method, String url, Response.Listener<T> listener, Response.ErrorListener errorListener, Class<T> classType) {
        this(method, url, null, null, null, listener, errorListener, classType);
    }

    public JsonBodyObjectRequest(int method, String url, Map<String, String> params, Response.Listener<T> listener, Response.ErrorListener errorListener, Class<T> classType) {
        this(method, url, null, params, null, listener, errorListener, classType);
    }

    public JsonBodyObjectRequest(int method, String url, Map<String, String> headers, Map<String, String> params, Response.Listener<T> listener, Response.ErrorListener errorListener, Class<T> classType) {
        this(method, url, headers, params, null, listener, errorListener, classType);
    }

    public JsonBodyObjectRequest(int method, String url, Map<String, String> headers, Map<String, String> params, byte[] body, Response.Listener<T> listener, Response.ErrorListener errorListener, Class<T> classType) {
