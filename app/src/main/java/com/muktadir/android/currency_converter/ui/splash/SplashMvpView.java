...
import com.muktadir.android.currency_converter.ui.base.MvpView;
...
interface SplashMvpView extends MvpView {
    void onCurrencyConverterDataLoadedSuccessful(ApiResponse apiResponse);

    void onCurrencyConverterDataLoadedFailed();
}